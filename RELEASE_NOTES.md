...
- **Movement**: Adaptive strafe timing with ±25% jitter, skill-gated bunny hopping (roam: skill 5+, far combat: skill 3+, retreat: skill 4+), skill-scaled ambush patience and turn speed (18-30°/frame). Speed-scaled whisker distance for smoother high-speed navigation. Circle strafing (skill 5+: 60-75°, skill 3-4: 75-85°). Elevation preference biases strafing toward higher ground.
- **Navigation Humanization**: Seven movement systems to eliminate robotic tells. Bunny hop rhythm variance (0.28-0.50s timing, 10-22deg strafe). Velocity momentum blending (lerp instead of instant snap). S-curve turns (Hermite smoothstep "whip and settle"). Graduated edge friction (two-tier 64u/32u braking). Platform fidgeting (micro-drift + look-around on lifts). Roaming speed variation (180-240, corner slowdown, micro-pauses). Swimming clumsiness (pitch wobble + sluggish velocity blend).
